    ...
    <main className="min-h-screen bg-[#faf7f2] p-4 md:p-6">
      <div className="mx-auto grid max-w-7xl gap-4 xl:grid-cols-[280px_1fr]">
        <aside className="card p-4 xl:sticky xl:top-4 xl:h-[calc(100vh-2rem)]">
          ...
          <nav className="mt-4 grid gap-2 text-sm font-bold">{['Konfiguration','WhatsApp','Benachrichtigungen','AI-Nachrichten','Kalender','Öffnungszeiten','Posteingang','Leistungen','Team','KI-Test','Statistiken'].map((item) => <a className="rounded-xl px-3 py-2 hover:bg-white" href={`#${item}`} key={item}>{item}</a>)}</nav>
        </aside>
        ...
        <section className="grid gap-4">
          ...
          <div id="Benachrichtigungen" className="card p-5">
